...
Процедура ПриДобавленииПодсистемы(Описание) Экспорт
	...
	Описание.Имя    = "УправлениеКачеством";
	Описание.Версия = "1.1.1.00";
	Описание.ИдентификаторИнтернетПоддержки = "SSL";
	Описание.РежимВыполненияОтложенныхОбработчиков = "Параллельно";
	//Описание.ПараллельноеОтложенноеОбновлениеСВерсии = "2.3.3.0"; ...
	Описание.ЗаполнятьДанныеНовыхПодсистемПриПереходеСДругойПрограммы = Ложь;
...
Процедура ТестоваяПроцедураОшибки()

СправочникСтраныМира = Справочники.СтраныМира.НайтиПоНаименованию("Тест");
РеквизитЧерезТочку = СправочникСтраныМира.КодАльфа2;
